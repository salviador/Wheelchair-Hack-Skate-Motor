...
void Motor_Convert_Joy(struct CHART_data_TX *bleJOY, struct CHART_data_TX *wheelJOY){
  ...
  //  wheelJOY->uJoy_x = wheelJOY->uJoy_x + 86;
  //  wheelJOY->uJoy_y = wheelJOY->uJoy_y + 67;
    ...
    if(wheelJOY->uJoy_y < 0){
      wheelJOY->uJoy_y= map(wheelJOY->uJoy_y,-935,0,-1000,0);
    }else if(wheelJOY->uJoy_y > 0){
      wheelJOY->uJoy_y= map(wheelJOY->uJoy_y,0,950,0,1000);
    }
    if(wheelJOY->uJoy_x < 0){
      wheelJOY->uJoy_x= map(wheelJOY->uJoy_x,-970,0,-1000,0);
    }else if(wheelJOY->uJoy_x > 0){
      wheelJOY->uJoy_x= map(wheelJOY->uJoy_x,0,915,0,1000);
    }
